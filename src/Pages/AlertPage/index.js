...
const AlertPage = () => {
  ...
  const API_URI = `${process.env.REACT_APP_API_URI}/Alerts`;
      ...
      <div>
        ...
        <div className="row mx-0 mb-4">
          {alerts.map((data, index) => {
            return (
              <div key={index} className="col-lg-3 col-sm-6 mb-3 p-0">
                <div
                  className={`${data.background} mr-3 alerts-main flex-xl-row flex-lg-column cr-p`}
                >
                  <div className={`${data.alertIconbg} alert-icon`}>
                    {data.alertIcon}
                  </div>
                  <p className="text-lg-center text-xl-left font-18-22 font-weight-500">
                    {data.alertName}
                  </p>
                </div>
              </div>
            ...
            <span className="view-all-btn d-flex gap-8px">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M3.73755 5.26094C3.99644 4.99914 4.41855 4.99678 4.68035 5.25567L5.91826 6.4798L7.15616 5.25567C7.41796 4.99678 7.84007 4.99914 8.09896 5.26094C8.35785 5.52274 8.35549 5.94485 8.09368 6.20373L6.38702 7.89142C6.12728 8.14826 5.70923 8.14826 5.4495 7.89142L3.74283 6.20374C3.48103 5.94485 3.47867 5.52274 3.73755 5.26094Z"
                  fill="white"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M5.92155 0C6.28974 0 6.58822 0.298477 6.58822 0.666667V7.37125C6.58822 7.73944 6.28974 8.03791 5.92155 8.03791C5.55336 8.03791 5.25488 7.73944 5.25488 7.37125V0.666667C5.25488 0.298477 5.55336 0 5.92155 0Z"
                  fill="white"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M0.666667 5.39267C1.03486 5.39267 1.33333 5.69115 1.33333 6.05934C1.33333 7.36354 1.77954 8.51045 2.56412 9.32721C3.34417 10.1393 4.49843 10.6667 6 10.6667C7.50158 10.6667 8.65583 10.1393 9.43589 9.32721C10.2205 8.51045 10.6667 7.36354 10.6667 6.05934C10.6667 5.69115 10.9651 5.39267 11.3333 5.39267C11.7015 5.39267 12 5.69115 12 6.05934C12 7.66903 11.4462 9.15911 10.3975 10.2509C9.34417 11.3474 7.83176 12 6 12C4.16824 12 2.65583 11.3474 1.60255 10.2509C0.553798 9.15911 0 7.66903 0 6.05934C0 5.69115 0.298477 5.39267 0.666667 5.39267Z"
                  fill="white"
                />
              </svg>
              Download Report
                ...
                return (
                  <tr key={index}>
                    ...
                    <td>
                      <span
                        className={`prority ${
                          data.AlertPrority === "Urgent"
                            ? "urgent"
                            : data.AlertPrority === "High"
                            ? "high"
                            : "low"
                        }`}
                      >
