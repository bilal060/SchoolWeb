                    ...
                    <div className='register-sub'>
                        ...
                        <form onSubmit={(e) => { submitHandler(e) }}>
                            ...
                            <div className='d-flex align-items-start mb-5 gap-8px'>
                                <input type='checkbox' id='remember' className='mt-5px' onChange={() => setTermsCheck(!termsCheck)} />
                                <label htmlFor='remember' className='font-16 font-weight-700 letter-spacing'>
                                    By signing up, you’re agree to our, <span className='text-blue'> Terms & Condition </span>
                                    and <span className='text-blue'> Privacy Policy</span>
                                </label>
                            </div>
                            <div>
                                <button type='submit' className='register-btn w-100' disabled={termsCheck ? false : true}>Create Account</button>
                            </div>
                        </form>
                    </div>
                </RegistrationLayout>
