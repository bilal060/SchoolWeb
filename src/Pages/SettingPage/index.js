...
const SettingsPage = () => {
    ...
    const API_URI = `http://localhost:4000//UpdateUserSetting/${userData?._id}`
    ...
    return (
        <>
            ...
            <div className='bg-white rounded-8 p-3 d-flex flex-column justify-content-center align-items-center'>
                <form onSubmit={(e) => { submitHandler(e) }} className="w-75">
                    <div className='d-flex justify-content-between align-items-center mb-5'>
                        <div className='d-flex justify-content-between align-items-center h-100 gap-16px'>
                            <div className='setting-user-img'>
                                <img src={file === null ? userData?.image : file} className='w-100 h-100' alt='current user' />
                            </div>

                            <div className='d-flex flex-column justify-content-between gap-16px h-100'>
                                <h2 className='text-capitalize font-24-100 font-weight-700'>{userData?.name}</h2>
                    ...
                    <div className='form-control mb-32px'>
                        ...
                        {passwordCheck &&
                            <div>
                                {newDetail.password?.length > 16 || newDetail.password?.length < 8 ?
                    ...
                    <div>
                        <button type='submit' className='register-btn w-100'>Update</button>
                    </div>
                </form>
            </div>
        </>
