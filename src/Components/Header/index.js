    ...
    <div className="app-header">
      ...
      <div className="d-flex gap-16px align-items-center">
        ...
        <div className="d-lg-flex d-none align-items-center ">
          <LocationIcon />
          <div className="pl-2">
            <p className="font-14-100 font-weight-500 text-grey mb-1">
              Location:
            </p>
            <p className="font-18-100 font-weight-600">
      ...
      <div className="d-md-flex d-none align-items-center gap-16px">
        <div className="d-md-block d-none">
          ...
          <p className="font-14-100 font-weight-500 text-grey text-capitalize">
            {userData?.name}
          </p>
        </div>
        <img
      ...
      <Dropdown className="d-md-none d-block">
        ...
        <Dropdown.Menu className="user-dropdown-menu">
          <Dropdown.Item className="border-bottom">
            <p className="font-18 font-weight-500 text-grey text-capitalize">
              {userData?.name}
            </p>
          </Dropdown.Item>
          <Dropdown.Item className="pt-3">
            <p className="font-14-100 font-weight-500 text-grey">
              {userData?.email}
            </p>
          </Dropdown.Item>
        </Dropdown.Menu>
